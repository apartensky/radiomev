/*app/views/datasets/_controllers/DatasetsVM*/
define('app/views/datasets/_controllers/DatasetsVM', ['ng'], function (ng) {
    var DatasetsVM = function () {
    };
    DatasetsVM.$inject = [];
    return DatasetsVM;
});
/*app/views/datasets/_templates/views.datasets2.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/_templates/views.datasets2.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="row">\n    <div class="col-md-3">\n        <div ui-view="workspace">Loading ....</div>\n    </div>\n    <div class="col-md-9 ">\n        <div class="column-wrapper">\n            <ul class="nav nav-tabs column-header" id="importTabs">\n                <li id="upload_tab" ui-sref-active="active"><a ui-sref=".imports.upload">Upload</a></li>\n<!--\n                <li id="tcga_tab" ui-sref-active="active"><a ui-sref=".imports.tcga">Import TCGA Datasets</a></li>\n                <li id="geods_tab" ui-sref-active="active"><a ui-sref=".imports.geods">Import GEO Datasets</a></li>\n                <li id="cccb_tab" ui-sref-active="active"><a ng-show="vm.showCccbTab()" ui-sref=".imports.cccb">CCCB Projects</a></li>\n                <li id="google_tab" ui-sref-active="active" ng-show="googleDrive.signedIn"><a ui-sref=".google">Google\n                    Drive</a></li>\n                <li id="tutorials_tab" ui-sref-active="active"><a ui-sref=".imports.tutorials" >Tutorials</a></li>\n-->\n            </ul>\n            <div class="tab-content column-body">\n                <div ui-view="imports">Loading ....</div>\n            </div>\n        </div>\n    </div>\n\n</div>\n';
});
/*app/views/datasets/_templates/views.datasets.tutorials.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/_templates/views.datasets.tutorials.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="row">\n    <div class="col-md-12">\n        <div class="row">\n            <div class="col-md-12">\n                <h4>Please see the <a href="https://www.youtube.com/watch?list=PLSUXpXpbiLkJFbC3LOMgBacvNSdNpw0nv&v=VqGpdotr-A4" target="_blank">WebMev Tutorials</a> playlist for more tutorials</h4>\n                <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLSUXpXpbiLkJFbC3LOMgBacvNSdNpw0nv" frameborder="0" allowfullscreen></iframe>\n            </div>\n    </div>\n</div>';
});
/*app/views/datasets/_templates/views.datasets.google.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/_templates/views.datasets.google.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="geo_import_container" ng-show="googleDrive.signedIn">\n    <table class="mev-table-tight table table-striped" style="font-size:14px;">\n        <thead>\n        <tr>\n            <th>File Name</th>\n            <th>Import</th>\n        </tr>\n        </thead>\n        <tbody>\n        <tr ng-repeat="file in googleDrive.files">\n            <td>{{file.name}}</td>\n            <td>\n                <a class="btn btn-small btn-success" href="" ng-click="postDriveFile(file.id)">Import</a>\n            </td>\n        </tr>\n        </tbody>\n    </table>\n\n</div>';
});
/*app/views/datasets/_templates/views.datasets.upload.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/_templates/views.datasets.upload.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="row">\n    <div class="col-md-3">\n        <div mev-dataset-upload></div>\n    </div>\n    <div class="col-md-9">\n        <h4>Upload a dataset</h4>\n        <p>Use the Upload button to upload a tab-delimited (tsv) data file.  The first row is assumed to contain headers and the first column contains the feature names (i.e. gene names).\n            Here is an example <a href="/container/ui/data/raw_count_matrix.rand.primary.counts.tsv">RNASeq read count file</a>\n            and an example of <a target="_blank" href="/container/ui/data/metadata.txt">metadata file</a> (metadata.txt) that can loaded once entered into the platform.</p>\n\n        <h4>MeV Dataset Archive</h4>\n        <p>You can download the entire MeV dataset as a ZIP archive by clicking the <span class="text-success"><i class="fa fa-file-archive-o text-success"></i> icon</span> next to the dataset name. This archive will contain the original data as well as any analyses and annotations.</p>\n        <p>The MeV archive can be uploaded back into MeV for viewing or continued analysis. To do so use the Upload button.</p>\n\n        <h4>Note on Data Storage</h4>\n        <p>MeV does not store your data on the server beyond the duration of your session. Once your session times out - all your data is deleted from the server.</p>\n        <p>Your dataset and analyses are saved to the browser\'s local storage on your computer. You will find them under "Offline Datatasets" section below "Your Datasets"</p>\n        <p>You may activate an offline dataset for viewing or further analysis by clicking the <span class="text-success"><i class="glyphicon glyphicon-cloud-upload"></i> icon</span> next to the offline dataset</p>\n        <p>Please note, the amount of disk space available to save offline datasets is determined by your browser. If this disk quota is exceeded the browser will delete the offline datasets.</p>\n        <p>To ensure your MeV dataset is saved indefinitely you may download it to your machine as a zip archive.</p>\n\n        <h4>Tutorials</h4>\n        <p>Please see the videos in the <a href="https://www.youtube.com/watch?list=PLSUXpXpbiLkJFbC3LOMgBacvNSdNpw0nv&v=VqGpdotr-A4" target="_blank">Web MeV Tutorials</a> playlist</p>\n    </div>\n</div>';
});
/*app/views/datasets/_templates/views.datasets.geods.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/_templates/views.datasets.geods.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="row">\n    <div class="col-md-12">\n        <p>\n            The query limits the results to GEO DataSets (GDS), the Series (GSE) files are <i>not included</i> because they have not been curated.\n            Please refer to this GEO FAQ for <a _target="_blank" href="http://www.ncbi.nlm.nih.gov/geo/info/faq.html#seriesdataset">more information</a>.\n        </p>\n        <!--<blockquote>-->\n            <!--<p class="small">GDS: DataSet full SOFT file (recommeded): Contains DataSet information, experiment variable subsets, expression value measurements and comprehensive up-to-date gene annotation for the DataSet Platform (plain text, tab-delimited format).</p>-->\n        <!--</blockquote>-->\n        <p>If you cannot find a dataset, please try looking for it on the\n            <a target="_blank" href="http://www.ncbi.nlm.nih.gov/gds/?term=gds%5BEntry+Type%5D">GEO website</a> and then using its GDS ID to import into MeV.</p>\n    </div>\n</div>\n<div class=\'row\'>\n    <div class=\'col-md-12\' id="geodsImportMgr" mev-geods-import-directive></div>\n</div>\n';
});
/*app/views/datasets/_templates/views.datasets.cccb.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/_templates/views.datasets.cccb.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="row">\n    <div class="col-md-12">\n            <h5>Click on a project file name to import</h5>         \n    </div>\n</div>\n<div class=\'row\'>\n    <div class=\'col-md-12\'>\n        <table class="mev-table-tight table table-striped" style="font-size:14px;">\n            <thead>\n            <tr>\n                <th>Project</a></th>\n                <th>Files</th>\n            </tr>\n            </thead>\n            <tbody>\n            <tr dir-paginate="project in vm.getProjects() | itemsPerPage: vm.itemsPerPage" total-items="vm.project.length"\n                current-page="vm.pagination.current">\n                <td>\n                    <dl>\n                        <dt>{{project.project_id}}</dt>\n                        <dd ng-if="project.description">{{project.description}}</dd>\n                    </dl>\n                </td>\n                <td>\n                    <dl>\n                        <dt ng-repeat-start="file in project.files">\n                            <a href="" ng-click="vm.import(project, file)">{{file.name}}</a>\n                        </dt>\n                        <dd ng-repeat-end ng-if="file.description">{{file.description}}</dd>\n                    </dl>\n                </td>\n            </tr>\n            <tr>\n            <tr ng-show="vm.projects.length==0 && vm.keywords!=\'\'">\n                <td colspan="5">\n                    No projects found.\n                </td>\n            </tr>\n            </tbody>\n        </table>\n    </div>\n</div>\n';
});
/*app/views/datasets/_templates/views.datasets.imports.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/_templates/views.datasets.imports.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div ui-view>Loading ....</div>\n';
});
/*app/widgets/presets/_templates/PresetsListVM*/
define('app/widgets/presets/_templates/PresetsListVM', ['ng'], function (ng) {
...
/*app/widgets/presets/_templates/presetsList.tpl.html!system-text@0.1.0#text*/
define('app/widgets/presets/_templates/presetsList.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="mev-preset-list-wrapper">\n\n<div id="presetsGrid" class="gridStyle" ng-grid="PresetsListVM.gridOptions" ></div>\n</div>\n\n<mev-bs-modal id="import-presets-dialog" bindid="import-presets-modal" func="" header="Import TCGA Datasets">\n<iframe  scrolling="no" frameborder="0" width="99%" height="80%" ng-src="{{PresetsListVM.importPresetUrl}}" /> \n</mev-bs-modal>';
});
/*app/widgets/presets/_templates/presetsListDirective*/
define('app/widgets/presets/_templates/presetsListDirective', ['./presetsList.tpl.html'], function (template) {
    'use strict';
...
define('app/widgets/presets/widgets.presets.module', [
    'mui',
    '../../domain/presets/domain.presets.module',
    './_templates/PresetsListVM',
    './_templates/presetsListDirective'
], function (ng, PresetsListVM, PresetsListDirective) {
    var module = ng.module('mui.widgets.presets', ['mui.domain.presets.tcga'], arguments);
    return module;
});
/*app/views/datasets/session/timeout/sessionTimeoutModal.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/session/timeout/sessionTimeoutModal.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">\n\n    <div class="modal-content">\n        <div class="modal-header">\n            <button type="button" class="close" ng-click="dismiss()" aria-hidden="true">\xD7</button>\n            <h3 id="myModalLabel">Session Timeout</h3>\n        </div>\n        <div class="modal-body">\n\n            <form role="form">\n                <div class="btn-gruop">\n                    <label>Your session has timed out.</label>\n                </div>\n                <a class="btn btn-info btn-block" ng-click="dismiss()" aria-hidden="true">OK</a>\n            </form>\n\n\n        </div>\n    </div>\n\n</div>\n';
});
/*app/views/datasets/session/timeout/SessionTimeoutState*/
define('app/views/datasets/session/timeout/SessionTimeoutState', ['./sessionTimeoutModal.tpl.html'], function (template) {
    var config = function ($stateProvider) {
        $stateProvider.state('root.datasets.sessionTimeout', {
...
/*app/views/datasets/session/views.datasets.session.module*/
define('app/views/datasets/session/views.datasets.session.module', [
    'mui',
    './timeout/SessionTimeoutState'
], function (ng) {
    return ng.module('views.datasets.session', arguments, arguments);
});
/*app/views/datasets/error/errorModal.tpl.html!system-text@0.1.0#text*/
define('app/views/datasets/error/errorModal.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
...
/*app/views/datasets/error/errorState*/
define('app/views/datasets/error/errorState', ['./errorModal.tpl.html'], function (template) {
    var config = function ($stateProvider) {
        $stateProvider.state('root.datasets.error', {
            parent: 'root.datasets',
            params: {
...
/*app/views/datasets/error/views.datasets.error.module*/
define('app/views/datasets/error/views.datasets.error.module', [
    'mui',
    './errorState'
], function (ng) {
    return ng.module('views.datasets.error', arguments, arguments);
});
/*mev-subscriber@0.0.1#src/main/endpoint/rest/SubscriberRest*/
define('mev-subscriber@0.0.1#src/main/endpoint/rest/SubscriberRest', ['lodash'], function (_) {
    var SelectionRest = function ($resource, $http, $rootScope, $q) {
        var resource = $resource('/subscriber', { 'format': 'json' }, {
            'getAll': { 'method': 'GET' },
            'put': { 'method': 'PUT' },
...
/*mev-subscriber@0.0.1#src/main/model/Subscriber*/
define('mev-subscriber@0.0.1#src/main/model/Subscriber', ['lodash'], function (_) {
    'use strict';
...
/*mev-subscriber@0.0.1#src/main/router/SubscriberState*/
define('mev-subscriber@0.0.1#src/main/router/SubscriberState', [], function () {
    var config = function ($stateProvider, $urlRouterProvider) {
        $urlRouterProvider.deferIntercept();
        $stateProvider.state('root.datasets.subscribe', {
            url: '/subscribe',
            parent: 'root.datasets',
            displayName: false
        });
...
/*mev-subscriber@0.0.1#src/main/view/signup/form/subscriberSignup.tpl.html!system-text@0.1.0#text*/
define('mev-subscriber@0.0.1#src/main/view/signup/form/subscriberSignup.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<form role="form">\n    <div class="form-group">\n        <span class="lead">Please join our email list to support the WebMeV team to continue provide and improve our web services to the community</span>\n    </div>\n    <div class="errors" ng-if="vm.errors.length>0">\n        <p class="error bg-warning " ng-repeat="error in vm.errors">{{error.message}}</p>\n    </div>\n    <div class="form-group">\n        <label class="mev-param-label" >Email*</label>\n        <input type="email" ng-model="vm.fields.email" placeholder="Email: you@email.com">\n    </div>\n    <div class="form-group">\n        <label class="mev-param-label" >Name</label>\n        <input ng-model="vm.fields.name" placeholder="Name">\n    </div>\n    <div class="form-group">\n        <a class="btn btn-success" ng-click="vm.ok()" aria-hidden="true">Yes</a>\n        <a class="btn btn-info" ng-click="vm.cancel()" aria-hidden="true">No</a>\n    </div>\n</form>';
});
/*mev-subscriber@0.0.1#src/main/view/signup/form/subscriberSignupDirective*/
define('mev-subscriber@0.0.1#src/main/view/signup/form/subscriberSignupDirective', [
    'lodash',
    './subscriberSignup.tpl.html',
    './subscriberSignup.less'
], function (_, template) {
            ...
            controller: [
                ...
                function (scope) {
                    ...
                    function validate() {
                        ...
                        if (_.isEmpty(this.fields.email) || this.fields.email.indexOf('@') < 0) {
                            this.errors.push({ message: 'Please provide a valid email' });
                        }
...
/*mev-subscriber@0.0.1#src/main/view/signup/modal/subscriberModal.tpl.html!system-text@0.1.0#text*/
define('mev-subscriber@0.0.1#src/main/view/signup/modal/subscriberModal.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">\n    <div class="modal-content">\n        <div class="modal-header">\n            <h3 id="myModalLabel">Signup for Web MeV</h3>\n        </div>\n        <div class="modal-body">\n            <mev-subscriber-form></mev-subscriber-form>\n        </div>\n    </div>\n</div>';
});
/*mev-subscriber@0.0.1#src/main/view/signup/modal/subscriberModal*/
define('mev-subscriber@0.0.1#src/main/view/signup/modal/subscriberModal', [
    'mui',
    './subscriberModal.tpl.html'
...
/*mev-subscriber@0.0.1#src/main/view/signup/prompt/subscriberPrompt*/
define('mev-subscriber@0.0.1#src/main/view/signup/prompt/subscriberPrompt', [], function () {
    function subscriberPrompt(mevSubscriberModal, mevSubscriber) {
        return function () {
            if (!mevSubscriber.exists())
                mevSubscriberModal().then(function (response) {
...
/*mev-subscriber@0.0.1#src/main/util/cookieUtil*/
define('mev-subscriber@0.0.1#src/main/util/cookieUtil', ['lodash'], function (_) {
    function cookieUtil() {
...
/*mev-subscriber@0.0.1#src/main/mev-subscriber*/
define('mev-subscriber@0.0.1#src/main/mev-subscriber', [
    'mui',
    'mev-domain-common',
    'angular-ui-router',
    'ui-router-extras',
...
/*ng-grid@2.0.14#ng-grid-2.0.14.min*/
define('ng-grid@2.0.14#ng-grid-2.0.14.min', [
    'module',
    '@loader'
...
/*geods/Geods.module*/
define('geods/Geods.module', ['angular'], function (angular) {
    var module = angular.module('Mev.GeodsModule', []);
    module.path = '/container/javascript/geods/';
    return module;
});
/*geods/import/GeodsImportCtrl*/
define('geods/import/GeodsImportCtrl', [
    'angular',
    'geods/Geods.module'
], function (angular, angularModule) {
    angular.module(angularModule.name).controller('MevGeodsImportCtrl', [
        '$scope',
        '$element',
        '$attrs',
...
/*geods/import/geodsimport.tpl.html!system-text@0.1.0#text*/
define('geods/import/geodsimport.tpl.html!system-text@0.1.0#text', function (require, exports, module) {
    module.exports = '<div class="geo_import_container">\n    <input type="text" id="uid" ng-model="vm.keywords"/>\n    <button id="find" value="find" ng-click="vm.searchByKeyword(vm.keywords)">find</button>\n    <dir-pagination-controls on-page-change="vm.pageChanged(newPageNumber)"></dir-pagination-controls>\n    <div class="current-page-label" ng-if="vm.results.results">\n        {{vm.firstRecordNumber()}}-{{vm.lastRecordNumber()}} of {{vm.recordCount() }}\n    </div>\n    <table class="mev-table-tight table table-striped" style="font-size:14px;">\n        <thead>\n        <tr>\n            <th>Dataset Name</a></th>\n            <th>Summary</th>\n            <th>#Samples</th>\n            <th colspan="2">Platform</th>\n        </tr>\n        </thead>\n        <tbody>\n        <tr dir-paginate="summary in vm.results.summaries | itemsPerPage: vm.itemsPerPage" total-items="vm.recordCount()" current-page="vm.pagination.current">\n            <td>{{summary.title}}</td>\n            <td>{{summary.summary}}</td>\n            <td>{{summary.n_samples}}</td>\n            <td>{{summary.platformtitle}}</td>\n            <td><a class="btn btn-small btn-success" href="" ng-click="vm.import(summary)">import</a></td>\n        </tr>\n        <tr>\n        <tr ng-show="vm.results.summaries.length==0 && vm.keywords!=\'\'">\n            <td colspan="5">\n                No datasets found that match your criteria.\n            </td>\n        </tr>\n        <tr ng-show="vm.results==null">\n            <td colspan="5">\n                Search GEO datasets.\n            </td>\n        </tr>\n        </tbody>\n    </table>\n\n\n    <!-- <div ng-repeat="summary in vm.results.summaries"> -->\n    <!-- \t<div> -->\n    <a href="" ng-click="vm.import(summary)">{{summary.title}}</a>\n    <!-- \t</div> -->\n    <!-- </div> -->\n</div>';
});
/*geods/domain/GeodsSummaryViewModel*/
define('geods/domain/GeodsSummaryViewModel', ['lodash'], function (_) {
...
/*geods/domain/GeodsSummary*/
define('geods/domain/GeodsSummary', [], function () {
...
define('geods/services/MevGeodsSummaryResourceSrvc', [
    'angular',
    'geods/Geods.module',
    'angular-route',
    'geods/domain/GeodsSummary'
], function (angular, angularModule, ngResource, GeodsSummary) {
    angularModule.service('MevGeodsSummaryResourceSrvc', [
        '$resource',
        function ($resource) {
            var eutilsRootUrl = 'https://eutils.ncbi.nlm.nih.gov/entrez/eutils/';
            var eutilsSummaryUrl = eutilsRootUrl + 'esummary.fcgi';
            return $resource(eutilsSummaryUrl, {
                db: 'gds',
                retmode: 'json'
            });
        }
...
define('geods/services/MevGeodsSearchResourceSrvc', [
    'angular',
    'geods/Geods.module'
], function (angular, angularModule) {
    angularModule.service('MevGeodsRepositorySrvc', [
        'MevGeodsSearchResourceSrvc',
        function (MevGeodsSearchResourceSrvc) {
        }
...
define('geods/domain/GeodsSearchResult', [], function () {
    var self = this;
    var GeodsSearchResult = function (dataPromise, GeodsSummaryFactory) {
        ...
        function _parseSummaries(data) {
            ...
            for (var uid in data.summaries.result) {
                if (uid != 'uids') {
                    summaries.push(new _self.GeodsSummaryFactory.create(data.summaries.result[uid]));
                }
            }
            return summaries;
        }
...
define('geods/domain/GeodsSummaryFactory', [
    'geods/domain/GeodsSummary',
    'geods/domain/GeodsSearchResult'
    ...
    var GeodsSummaryFactory = function (MevGeodsSummaryResourceSrvc, MevGeodsSearchResourceSrvc, MevGeodsImportSrvc, $q, $rootScope) {
        ...
        this.get = function (id) {
            return new GeodsSummary(MevGeodsSummaryResourceSrvc.get({ id: id }).$promise.then(function (data) {
        ...
        this.search = function (keywords, page, max) {
            ...
            return new GeodsSearchResult(MevGeodsSearchResourceSrvc.get({
                ...
                return MevGeodsSummaryResourceSrvc.get({ id: uids.join() }).$promise;
            }).then(function (data) {
...
define('geods/services/MevGeodsImportSrvc', [
    'angular',
    'geods/Geods.module',
    'angular-route'
], function (angular, angularModule, ngResource) {
    angularModule.service('MevGeodsImportSrvc', [
        '$resource',
        function ($resource) {
            var rootUrl = '/geods';
            var putUrl = rootUrl + '/import/:id';
            return $resource(putUrl, null, { put: { method: 'PUT' } });
        }
    ]);
});
/*geods/services/MevGeodsSummaryFactory*/
define('geods/services/MevGeodsSummaryFactory', [
    'angular',
    'geods/Geods.module',
    'geods/domain/GeodsSummaryFactory',
    'angular-route',
    ...
    'geods/services/MevGeodsImportSrvc',
    'geods/services/MevGeodsSearchResourceSrvc'
], function (angular, angularModule, GeodsSummaryFactory) {
    angularModule.service('MevGeodsSummaryFactory', [
        'MevGeodsSummaryResourceSrvc',
        'MevGeodsImportSrvc',
        'MevGeodsSearchResourceSrvc',
        '$q',
        '$rootScope',
...
define('geods/import/GeodsImport.directives', [
    'angular',
    './geodsimport.tpl.html',
    'geods/Geods.module',
    'geods/import/GeodsImportCtrl',
    'geods/domain/GeodsSummaryViewModel',
    'geods/services/MevGeodsSummaryResourceSrvc',
...
], function (angular, importTemplate, angularModule, GeodsImportCtrl, GeodsSummaryViewModel) {
    angularModule.directive('mevGeodsImportDirective', [
        'MevGeodsSummaryFactory',
        '$modal',
        '$location',
        'MevGeodsSearchResourceSrvc',
        '$rootScope',
    ...
    ]).directive('mevGeodsSearchResultsDirective', [function () {
            return {
                scope: {},
                restrict: 'AE',
...
define('geods', [
    ...
    'geods/services/MevGeodsSummaryResourceSrvc',
    'geods/services/MevGeodsSummaryFactory',
    'geods/import/geodsimport.less'
], function (angular, module) {
});
/*app/views/datasets/views.datasets.module*/
define('app/views/datasets/views.datasets.module', [
    'mui',
        ...
        function ($stateProvider, $urlRouterProvider, $$animateJsProvider) {
            ...
            $stateProvider.state('root.datasets', {
                ...
                controller: [
                    '$scope',
                    'cccbProjects',
                    function (scope, cccbProjects) {
                        function hasProjects() {
                            return _.isArray(cccbProjects) && cccbProjects.length > 0;
                        }
                        scope.vm = { showCccbTab: hasProjects };
                    }
                ],
                resolve: {
                    'cccbProjects': [
                ...
                data: { headerUrl: 'app/views/datasets/_templates/views.datasets.header.tpl.html' }
            }).state('root.datasets.imports', {
                url: '',
                parent: 'root.datasets',
                displayName: false,
                views: { 'imports': { template: '<div ui-view></div>' } },
                sticky: true,
                onEnter: [
                    'mevFetchSrc',
                    'mevSubscriberPrompt',
                    function (mevFetchSrc, mevSubscriberPrompt) {
                        return mevFetchSrc.fetch('app/views/datasets/views.datasets.module', $$animateJsProvider).then(function () {
                            mevSubscriberPrompt();
                        }).catch(function (e) {
                            throw e;
                        });
                    ...
                    function (scope, cccbProjects, mevWorkspace, $http, $rootScope) {
                        _.assign(this, {
                            ...
                            import: function (project, file) {
                                ...
                                mevWorkspace.getDataset(file.name).then(renameIfExists).then(doImport);
                            }
                        });
                    }
                ]
